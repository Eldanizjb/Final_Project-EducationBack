        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageBack = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupTitle = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationOnMap = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metod = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Place = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    MentorTime = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Support = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ContactInfo = table.Column<string>(type: "ntext", nullable: true),
                    ...
                    FeatureImage = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    AboutVideo = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Enrolled = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ...
                    OldDiscountPrice = table.Column<decimal>(type: "money", nullable: true),
                    NewPrice = table.Column<decimal>(type: "money", nullable: false),
                    NewDiscountPrice = table.Column<decimal>(type: "money", nullable: true),
                    PricePercent = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MainImage = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorRaitings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstructorRaitings_Instructors_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Instructors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "InstructorToSocials",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InstructorId = table.Column<int>(type: "int", nullable: false),
                    InstructorSocialId = table.Column<int>(type: "int", nullable: false),
                    SocialId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorToSocials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstructorToSocials_Instructors_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Instructors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstructorToSocials_InstructorSocials_InstructorSocialId",
                        column: x => x.InstructorSocialId,
                        principalTable: "InstructorSocials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseCategoryToCourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseCategoryToCourses_CourseCategories_CourseCategoryId",
                        column: x => x.CourseCategoryId,
                        principalTable: "CourseCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseCategoryToCourses_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseCategoryToCourses_CourseCategoryId",
                table: "CourseCategoryToCourses",
                column: "CourseCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseCategoryToCourses_CourseId",
                table: "CourseCategoryToCourses",
                column: "CourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorRaitings_InstructorId",
                table: "InstructorRaitings",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_InstructorToSocials_InstructorId",
                table: "InstructorToSocials",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_InstructorToSocials_InstructorSocialId",
                table: "InstructorToSocials",
                column: "InstructorSocialId");
